...
// Forward Declaration refers to the beforehand declaration of the syntax 
// of an identifier, variable, function, class, etc. prior 
// to its usage (done later in the program). 
